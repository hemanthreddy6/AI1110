...
%\renewcommand{\theequation}{\theenumi}
%\subsection{Problem}
\textbf{Question: } An instructor has a question bank consisting of 300 easy True / False questions,
...
\textbf{Solution: }
Let $X$ and $Y$ be two random variables in which $X$ describes the difficulty level of question and $Y$ describes the type of question according to the table \ref{table:table1} :
...
\begin{align}
	...
	p_X(0)&=\frac{300+500}{300+200+500+400}\\
	\label{eq:eq3}
		&=\frac{4}{7}\\
	p_Y(0)&=\frac{300+200}{300+200+500+400}\\
	\label{eq:eq4}
		&=\frac{5}{14}
\end{align}
From \eqref{eq:eq7}, \eqref{eq:eq2}, \eqref{eq:eq3} and \eqref{eq:eq4},
\begin{align}
	p_X(1)&=1-p_X(0)\\
		&=\frac{3}{7}\\
	p_Y(1)&=1-p_Y(0)\\
	...
	p_{X,Y}(1,1)&=\frac{400}{1400}\\
				&=\frac{2}{7}
\end{align}
From \eqref{eq:eq5}, \eqref{eq:eq6}, \eqref{eq:eq3}, \eqref{eq:eq4} and \eqref{eq:eq8},
\begin{align}
...
%	\label{table:table2}
%\end{table}
The required probability is $p_{X|Y}(0|1)$

From the definition of conditional probability, We know that,
\begin{align}
	p_{X|Y}(x|y)=\frac{p_{X,Y}(x,y)}{p_Y(y)}\label{eq:eq1}
\end{align}
From \eqref{eq:eq9} and \eqref{eq:eq10},
\begin{align}
	p_{X|Y}(0|1)&=\frac{p_{X,Y}(0,1)}{p_Y(1)}\\
				&=\frac{\frac{5}{14}}{\frac{9}{14}}\\
				&=\frac{5}{9}\\
	\therefore~ p_{X|Y}(0|1)&=\frac{5}{9}
\end{align}
%\section{Chemistry}
