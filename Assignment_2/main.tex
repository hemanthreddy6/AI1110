...
Let $A$ be the event that it is an easy question and $B$ be the event that it is a multiple choice question
...
\end{align}
Here, $AB$ is the event of getting an easy multiple choice question
\begin{align}
	\pr{B}&=\frac{500+400}{300+200+500+400}\\
			&=\frac{900}{1400}\\
			&=\frac{9}{14}\\
	\therefore~ \pr{B}&=\frac{9}{14}
	\label{eq:2}
\end{align}
\begin{align}
	\pr{AB}&=\frac{500}{300+200+500+400}\\
			&=\frac{500}{1400}\\
			&=\frac{5}{14}\\
	\therefore~ \pr{AB}&=\frac{5}{14}
	\label{eq:3}
\end{align}
From \eqref{eq:1}, \eqref{eq:2} and \eqref{eq:3},
\begin{align}
	\pr{A | B}&=\frac{\frac{5}{14}}{\frac{9}{14}}\\
			&=\frac{5}{9}\\
	\therefore~ \pr{A | B}&=\frac{5}{9}
\end{align}
%\section{Chemistry}
